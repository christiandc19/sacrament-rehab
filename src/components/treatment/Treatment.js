...
<div className='service-1-image'>
      ...
      <div className='service-1-description'>
        <Fade right>
                    <br />
                    <h2 className='revisions'>Revisions</h2>
                    <br /> <br />
                    <p>
                    ...
                    <h2 className='recreation'>Recreation</h2>
                    <br /> <br />
                    <p>
                    ...
                    <br/>
                    <p>For more information about our addiction treatment programs, please contact Helping Hands Treatment Center today at <span>844 311-1705.</span></p>
